CREATE TABLE IF NOT EXISTS institutions (
  ...
  deleted_at DATETIME,
  deleted_by TEXT,
  created_at DATETEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS role_permissions (
  ...
  granted_at DATETEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
  revoked_at DATETIME,
...
CREATE TABLE IF NOT EXISTS encounters (
  ...
  started_at DATETEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS report_snapshots (
  ...
  generated_at DATETEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
  created_at DATETEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
);
